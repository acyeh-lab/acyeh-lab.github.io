...
MAPPING = {
    ...
    "BUV605":             None,          # not on FPbase — Gaussian fallback
    "BUV615":             None,
    ...
    # BD Horizon Brilliant Blue polymer dyes. Reported under their real names
    # rather than folded into FITC / PerCP-Cy5.5 -- they share those detectors
    # but have distinct spectra, so the panel needs the real curves.
    # Note FPbase spells BB700 with a hyphen and BB515 without.
    "BB515":              ("dye",     "BD Horizon BB515"),
    "BB700":              ("dye",     "BD Horizon - BB700"),
    ...
    "Alexa Fluor 568":    ("dye",     "Alexa Fluor 568"),
